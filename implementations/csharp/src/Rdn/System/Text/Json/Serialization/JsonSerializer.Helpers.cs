...
namespace Rdn
{
    public static partial class JsonSerializer
    {
        ...
        internal const string SerializationRequiresDynamicCodeMessage = "JSON serialization and deserialization might require types that cannot be statically analyzed and might need runtime code generation. Use Rdn source generation for native AOT applications.";
