...
namespace Rdn.Serialization
{
    ...
    /// <see cref="object"/>, the type of object created will either be a <see cref="Rdn.Nodes.JsonNode"/> or a
    /// <see cref="JsonElement"/> depending on the value of <see cref="Rdn.JsonSerializerOptions.UnknownTypeHandling"/>.
    ///
