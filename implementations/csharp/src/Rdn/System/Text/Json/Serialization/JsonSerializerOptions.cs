...
namespace Rdn
{
    ...
    public sealed partial class JsonSerializerOptions
    {
        ...
        public static JsonSerializerOptions Default
        {
            ...
            get => s_defaultOptions ?? GetOrCreateSingleton(ref s_defaultOptions, JsonSerializerDefaults.General);
        }
        ...
        public static JsonSerializerOptions Strict
        {
            [RequiresUnreferencedCode(JsonSerializer.SerializationUnreferencedCodeMessage)]
            [RequiresDynamicCode(JsonSerializer.SerializationRequiresDynamicCodeMessage)]
            get => s_strictOptions ?? GetOrCreateSingleton(ref s_strictOptions, JsonSerializerDefaults.Strict);
        }
