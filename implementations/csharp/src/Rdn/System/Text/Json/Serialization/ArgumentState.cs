...
using FoundProperties = System.ValueTuple<Rdn.Serialization.Metadata.JsonPropertyInfo, Rdn.JsonReaderState, long, byte[]?, string?>;
using FoundPropertiesAsync = System.ValueTuple<Rdn.Serialization.Metadata.JsonPropertyInfo, object?, string?>;
