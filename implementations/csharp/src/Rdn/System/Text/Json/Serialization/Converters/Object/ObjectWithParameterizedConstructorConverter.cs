...
using FoundProperty = System.ValueTuple<Rdn.Serialization.Metadata.JsonPropertyInfo, Rdn.JsonReaderState, long, byte[]?, string?>;
using FoundPropertyAsync = System.ValueTuple<Rdn.Serialization.Metadata.JsonPropertyInfo, object?, string?>;
