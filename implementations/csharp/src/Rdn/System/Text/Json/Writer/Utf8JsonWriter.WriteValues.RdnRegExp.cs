...
namespace Rdn
{
    public sealed partial class Utf8JsonWriter
    {
        ...
        private void WriteRdnRegExpValueMinimized(ReadOnlySpan<char> source, ReadOnlySpan<char> flags)
        {
            ...
            int maxRequired = 3 + source.Length * JsonConstants.MaxExpansionFactorWhileTranscoding + flags.Length * JsonConstants.MaxExpansionFactorWhileTranscoding;
        ...
        private void WriteRdnRegExpValueIndented(ReadOnlySpan<char> source, ReadOnlySpan<char> flags)
        {
            ...
            int maxRequired = indent + 3 + source.Length * JsonConstants.MaxExpansionFactorWhileTranscoding + flags.Length * JsonConstants.MaxExpansionFactorWhileTranscoding + _newLineLength;
