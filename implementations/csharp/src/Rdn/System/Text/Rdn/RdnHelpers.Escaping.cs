...
namespace Rdn
{
    internal static partial class RdnHelpers
    {
            ...
            JavaScriptEncoder? encoder)
        {
            ...
            RdnWriterHelper.EscapeString(utf8Value, escapedValue, firstEscapeIndexVal, encoder, out int written);
        ...
        private static byte[] GetPropertyNameSection(ReadOnlySpan<byte> utf8Value)
        {
            ...
            propertySection[0] = RdnConstants.Quote;
            utf8Value.CopyTo(propertySection.AsSpan(1, length));
            propertySection[++length] = RdnConstants.Quote;
            propertySection[++length] = RdnConstants.KeyValueSeparator;
