...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="ulong"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// </remarks>
        [CLSCompliant(false)]
        public void WriteNumber(RdnEncodedText propertyName, ulong value)
        {
        ...
        /// <summary>
        /// Writes the property name and <see cref="ulong"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="uint"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        /// <param name="propertyName">The RDN-encoded name of the property to write.</param>
        /// <param name="value">The value to write.</param>
        /// <exception cref="InvalidOperationException">
        ...
        /// </remarks>
        [CLSCompliant(false)]
        public void WriteNumber(RdnEncodedText propertyName, uint value)
            => WriteNumber(propertyName, (ulong)value);

        /// <summary>
        /// Writes the property name and <see cref="uint"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        /// <param name="propertyName">The name of the property to write.</param>
        /// <param name="value">The value to write.</param>
        /// <exception cref="ArgumentException">
        ...
        {
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - RdnConstants.MaximumFormatUInt64Length - 4);

            // All ASCII, 2 quotes for property name, and 1 colon => escapedPropertyName.Length + RdnConstants.MaximumFormatUInt64Length + 3
            // Optionally, 1 list separator, and up to 3x growth when transcoding
            int maxRequired = (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatUInt64Length + 4;
        ...
        {
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - RdnConstants.MaximumFormatUInt64Length - 4);

            int minRequired = escapedPropertyName.Length + RdnConstants.MaximumFormatUInt64Length + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<char> escapedPropertyName, ulong value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - indent - RdnConstants.MaximumFormatUInt64Length - 5 - _newLineLength);

            // All ASCII, 2 quotes for property name, 1 colon, and 1 space => escapedPropertyName.Length + RdnConstants.MaximumFormatUInt64Length + 4
            // Optionally, 1 list separator, 1-2 bytes for new line, and up to 3x growth when transcoding
            int maxRequired = indent + (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatUInt64Length + 5 + _newLineLength;
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, ulong value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - indent - RdnConstants.MaximumFormatUInt64Length - 5 - _newLineLength);

            int minRequired = indent + escapedPropertyName.Length + RdnConstants.MaximumFormatUInt64Length + 4; // 2 quotes for property name, 1 colon, and 1 space
        ...
        {
            Span<byte> utf8PropertyName = stackalloc byte[RdnConstants.MaximumFormatUInt64Length];
