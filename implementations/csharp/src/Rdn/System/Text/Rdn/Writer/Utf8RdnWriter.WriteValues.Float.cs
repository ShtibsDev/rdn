...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the <see cref="float"/> value (as a RDN number) as an element of a RDN array.
        /// </summary>
        ...
        public void WriteNumberValue(float value)
        {
            ...
            {
                ReadOnlySpan<byte> literal = float.IsNaN(value) ? RdnConstants.NaNValue : float.IsPositiveInfinity(value) ? RdnConstants.PositiveInfinityValue : RdnConstants.NegativeInfinityValue;
        ...
        {
            int maxRequired = RdnConstants.MaximumFormatSingleLength + 1; // Optionally, 1 list separator
        ...
        private void WriteNumberValueIndented(float value)
        {
            ...
            int maxRequired = indent + RdnConstants.MaximumFormatSingleLength + 1 + _newLineLength; // Optionally, 1 list separator and 1-2 bytes for new line
...
#else
            string utf16Text = value.ToString(RdnConstants.SingleFormatString, CultureInfo.InvariantCulture);
        ...
        {
            Span<byte> utf8Number = stackalloc byte[RdnConstants.MaximumFormatSingleLength];
