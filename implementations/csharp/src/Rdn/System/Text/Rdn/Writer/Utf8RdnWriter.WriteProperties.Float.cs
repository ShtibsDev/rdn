...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="float"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// </remarks>
        public void WriteNumber(RdnEncodedText propertyName, float value)
        {
            ...
            RdnWriterHelper.ValidateSingle(value);
        ...
        /// <summary>
        /// Writes the property name and <see cref="float"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        {
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - RdnConstants.MaximumFormatSingleLength - 4);

            // All ASCII, 2 quotes for property name, and 1 colon => escapedPropertyName.Length + RdnConstants.MaximumFormatSingleLength + 3
            // Optionally, 1 list separator, and up to 3x growth when transcoding
            int maxRequired = (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatSingleLength + 4;
        ...
        {
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - RdnConstants.MaximumFormatSingleLength - 4);

            int minRequired = escapedPropertyName.Length + RdnConstants.MaximumFormatSingleLength + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<char> escapedPropertyName, float value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - indent - RdnConstants.MaximumFormatSingleLength - 5 - _newLineLength);

            // All ASCII, 2 quotes for property name, 1 colon, and 1 space => escapedPropertyName.Length + RdnConstants.MaximumFormatSingleLength + 4
            // Optionally, 1 list separator, 1-2 bytes for new line, and up to 3x growth when transcoding
            int maxRequired = indent + (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatSingleLength + 5 + _newLineLength;
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, float value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - indent - RdnConstants.MaximumFormatSingleLength - 5 - _newLineLength);

            int minRequired = indent + escapedPropertyName.Length + RdnConstants.MaximumFormatSingleLength + 4; // 2 quotes for property name, 1 colon, and 1 space
        ...
        {
            Span<byte> utf8PropertyName = stackalloc byte[RdnConstants.MaximumFormatSingleLength];
