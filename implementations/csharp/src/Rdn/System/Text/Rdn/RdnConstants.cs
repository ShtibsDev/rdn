...
namespace Rdn
{
    internal static partial class RdnConstants
    {
        ...
        // The maximum number of characters allowed when writing raw UTF-16 RDN. This is the maximum length that we can guarantee can
        ...
        public const int DateTimeParseNumFractionDigits = 16; // The maximum number of fraction digits the Rdn DateTime parser allows
        ...
        public const int MaximumIndentSize = 127; // If this value is changed, the impact on the options masking used in the RdnWriterOptions struct must be checked carefully.
