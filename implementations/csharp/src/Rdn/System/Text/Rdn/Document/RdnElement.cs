...
{
    /// <summary>
    ///   Represents a specific RDN value within a <see cref="RdnDocument"/>.
    /// </summary>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly partial struct RdnElement
    {
        private readonly RdnDocument _parent;
        private readonly int _idx;

        internal RdnElement(RdnDocument parent, int idx)
        {
        ...
        private RdnTokenType TokenType
        {
            get
            {
                return _parent?.GetRdnTokenType(_idx) ?? RdnTokenType.None;
            }
        }
        /// <summary>
        ///   The <see cref="RdnValueKind"/> that the value is.
        /// </summary>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public RdnValueKind ValueKind => TokenType.ToValueKind();

        /// <summary>
        ///   Get the value at a specified index when the current value is a
        ///   <see cref="RdnValueKind.Array"/>.
        /// </summary>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Array"/>.
        /// </exception>
        ...
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public RdnElement this[int index]
        {
            get
            {
                CheckValidInstance();
        ...
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Object"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        ...
        /// <summary>
        ///   Gets a <see cref="RdnElement"/> representing the value of a required property identified
        ...
        /// <returns>
        ///   A <see cref="RdnElement"/> representing the value of the requested property.
        /// </returns>
        ...
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public RdnElement GetProperty(string propertyName)
        {
            ArgumentNullException.ThrowIfNull(propertyName);

            if (TryGetProperty(propertyName, out RdnElement property))
            {
                return property;
            }
        ...
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public RdnElement GetProperty(ReadOnlySpan<char> propertyName)
        {
            if (TryGetProperty(propertyName, out RdnElement property))
            {
                return property;
        ...
        /// </exception>
        /// <seealso cref="EnumerateObject"/>
        public RdnElement GetProperty(ReadOnlySpan<byte> utf8PropertyName)
        {
            if (TryGetProperty(utf8PropertyName, out RdnElement property))
            {
                return property;
            }
        ...
        /// </exception>
        /// <seealso cref="EnumerateObject"/>
        public bool TryGetProperty(string propertyName, out RdnElement value)
        {
            ArgumentNullException.ThrowIfNull(propertyName);
        ...
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public bool TryGetProperty(ReadOnlySpan<char> propertyName, out RdnElement value)
        {
            CheckValidInstance();
        ...
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public bool TryGetProperty(ReadOnlySpan<byte> utf8PropertyName, out RdnElement value)
        {
            CheckValidInstance();
        ...
        /// </summary>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        /// </remarks>
        /// <returns>The value of the element as a <see cref="bool"/>.</returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is neither <see cref="RdnValueKind.True"/> or
        ///   <see cref="RdnValueKind.False"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public bool GetBoolean()
        {
            ...
            return
                type == RdnTokenType.True ? true :
                type == RdnTokenType.False ? false :
                ThrowRdnElementWrongTypeException(type);

            static bool ThrowRdnElementWrongTypeException(RdnTokenType actualType)
            {
                throw ThrowHelper.GetRdnElementWrongTypeException(nameof(Boolean), actualType.ToValueKind());
            }
        }
        ...
        /// </summary>
        /// <remarks>
        ///   This method does not create a string representation of values other than RDN strings.
        /// </remarks>
        /// <returns>The value of the element as a <see cref="string"/>.</returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is neither <see cref="RdnValueKind.String"/> nor <see cref="RdnValueKind.Null"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        ...
        public string? GetString()
        {
            ...
            return _parent.GetString(_idx, RdnTokenType.String);
        }

        /// <summary>
        ///   Attempts to represent the current RDN string as bytes assuming it is Base64 encoded.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///  This method does not create a byte[] representation of values other than base 64 encoded RDN strings.
        /// </remarks>
        /// <returns>
        ...
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.String"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        ...
        /// </summary>
        /// <remarks>
        ///   This method does not create a byte[] representation of values other than Base64 encoded RDN strings.
        /// </remarks>
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as an <see cref="sbyte"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Number"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        ...
        /// <summary>
        ///   Gets the current RDN number as an <see cref="sbyte"/>.
        /// </summary>
        /// <returns>The current RDN number as an <see cref="sbyte"/>.</returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Number"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="byte"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="byte"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="byte"/>.</returns>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        /// </remarks>
        /// <exception cref="InvalidOperationException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as an <see cref="short"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as an <see cref="short"/>.
        /// </summary>
        /// <returns>The current RDN number as an <see cref="short"/>.</returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Number"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="ushort"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="ushort"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="ushort"/>.</returns>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        /// </remarks>
        /// <exception cref="InvalidOperationException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as an <see cref="int"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as an <see cref="int"/>.
        /// </summary>
        /// <returns>The current RDN number as an <see cref="int"/>.</returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Number"/>.
        /// </exception>
        /// <exception cref="FormatException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="uint"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="uint"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="uint"/>.</returns>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        /// </remarks>
        /// <exception cref="InvalidOperationException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="long"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="long"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="long"/>.</returns>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        /// </remarks>
        /// <exception cref="InvalidOperationException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="ulong"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="ulong"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="ulong"/>.</returns>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        /// </remarks>
        /// <exception cref="InvalidOperationException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="double"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   <para>
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="double"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="double"/>.</returns>
        /// <remarks>
        ///   <para>
        ///     This method does not parse the contents of a RDN string value.
        ///   </para>
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="float"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   <para>
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="float"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="float"/>.</returns>
        /// <remarks>
        ///   <para>
        ///     This method does not parse the contents of a RDN string value.
        ///   </para>
        ...
        /// <summary>
        ///   Attempts to represent the current RDN number as a <see cref="decimal"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        ...
        /// <summary>
        ///   Gets the current RDN number as a <see cref="decimal"/>.
        /// </summary>
        /// <returns>The current RDN number as a <see cref="decimal"/>.</returns>
        /// <remarks>
        ///   This method does not parse the contents of a RDN string value.
        /// </remarks>
        /// <exception cref="InvalidOperationException">
        ...
        /// <summary>
        ///   Attempts to represent the current RDN string as a <see cref="DateTime"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not create a DateTime representation of values other than RDN strings.
        /// </remarks>
        /// <returns>
        ...
        /// <summary>
        ///   Attempts to represent the current RDN string as a <see cref="DateTimeOffset"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not create a DateTimeOffset representation of values other than RDN strings.
        /// </remarks>
        /// <returns>
        ...
        /// <summary>
        ///   Attempts to represent the current RDN string as a <see cref="Guid"/>.
        /// </summary>
        /// <param name="value">Receives the value.</param>
        /// <remarks>
        ///   This method does not create a Guid representation of values other than RDN strings.
        /// </remarks>
        /// <returns>
        ...
        /// <summary>
        /// Compares the values of two <see cref="RdnElement"/> values for equality, including the values of all descendant elements.
        /// </summary>
        /// <param name="element1">The first <see cref="RdnElement"/> to compare.</param>
        /// <param name="element2">The second <see cref="RdnElement"/> to compare.</param>
        /// <returns><see langword="true"/> if the two values are equal; otherwise, <see langword="false"/>.</returns>
        /// <remarks>
        /// Deep equality of two RDN values is defined as follows:
        /// <list type="bullet">
        /// <item>RDN values of different kinds are not equal.</item>
        /// <item>RDN constants <see langword="null"/>, <see langword="false"/>, and <see langword="true"/> only equal themselves.</item>
        /// <item>RDN numbers are equal if and only if they have they have equivalent decimal representations, with no rounding being used.</item>
        /// <item>RDN strings are equal if and only if they are equal using ordinal string comparison.</item>
        /// <item>RDN arrays are equal if and only if they are of equal length and each of their elements are pairwise equal.</item>
        /// <item>
        ///     RDN objects are equal if and only if they have the same number of properties and each property in the first object
        ...
        /// </list>
        /// </remarks>
        public static bool DeepEquals(RdnElement element1, RdnElement element2)
        {
            if (!StackHelper.TryEnsureSufficientExecutionStack())
            {
                ThrowHelper.ThrowInsufficientExecutionStackException_RdnElementDeepEqualsInsufficientExecutionStack();
            }

            element1.CheckValidInstance();
            element2.CheckValidInstance();

            RdnValueKind kind = element1.ValueKind;
            ...
            switch (kind)
            {
                case RdnValueKind.Null or RdnValueKind.False or RdnValueKind.True:
                    return true;
                ...
                case RdnValueKind.String:
                    if (element2.ValueIsEscaped)
                    {
                        if (element1.ValueIsEscaped)
                        {
                            ...
                            return RdnReaderHelper.UnescapeAndCompareBothInputs(element1.ValueSpan, element2.ValueSpan);
                        }
                ...
                case RdnValueKind.Map:
                    ...
                    {
                        RdnValueKind.Set => element2.EnumerateSet(),
                        RdnValueKind.Map => element2.EnumerateMap(),
                        _ => element2.EnumerateArray(),
                    };
                    foreach (RdnElement e1 in kind switch
                    {
                        RdnValueKind.Set => element1.EnumerateSet(),
                        RdnValueKind.Map => element1.EnumerateMap(),
                ...
                default:
                    Debug.Assert(kind is RdnValueKind.Object);
                    ...
                    // Two RDN objects are considered equal if they define the same set of properties.
                    ...
                    while (objectEnumerator1.MoveNext())
                    {
                        ...
                        RdnProperty prop1 = objectEnumerator1.Current;
                        RdnProperty prop2 = objectEnumerator2.Current;
                    ...
                    {
                        // RdnElement objects allow duplicate property names, which is optional per the RDN RFC.
                        ...
                        // This is to preserve a degree of coherence with RDN serialization, where either the first
                        ...
                        Dictionary<string, ValueQueue<RdnElement>> properties2 = new(capacity: remainingProps, StringComparer.Ordinal);
                        do
                        {
                            RdnProperty prop2 = objectEnumerator2.Current;
#if NET
                            ref ValueQueue<RdnElement> values = ref CollectionsMarshal.GetValueRefOrAddDefault(properties2, prop2.Name, out bool _);
#else
                            properties2.TryGetValue(prop2.Name, out ValueQueue<RdnElement> values);
#endif
                        ...
                        do
                        {
                            RdnProperty prop = objectEnumerator1.Current;
#if NET
                            ref ValueQueue<RdnElement> values = ref CollectionsMarshal.GetValueRefOrAddDefault(properties2, prop.Name, out bool exists);
#else
                            bool exists = properties2.TryGetValue(prop.Name, out ValueQueue<RdnElement> values);
#endif
                            if (!exists || !values.TryDequeue(out RdnElement value) || !DeepEquals(prop.Value, value))
                            {
                                return false;
                            }
#if !NET
                    ...
                    static bool NameEquals(RdnProperty left, RdnProperty right)
                    {
                        if (right.NameIsEscaped)
                        {
                            ...
                            {
                                // Need to unescape and compare both inputs.
                                return RdnReaderHelper.UnescapeAndCompareBothInputs(left.NameSpan, right.NameSpan);
                            }
...
#pragma warning restore CA2265
        ...
        /// <summary>
        ///   Write the element into the provided writer as a RDN value.
        /// </summary>
        ...
        /// </exception>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is <see cref="RdnValueKind.Undefined"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        ...
        internal void WritePropertyNameTo(Utf8RdnWriter writer)
        {
            CheckValidInstance();
        ...
        /// <summary>
        ///   Get an enumerator to enumerate the values in the RDN array represented by this RdnElement.
        /// </summary>
        /// <returns>
        ///   An enumerator to enumerate the values in the RDN array represented by this RdnElement.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Array"/>.
        /// </exception>
        ...
        public ArrayEnumerator EnumerateArray()
        {
            ...
            RdnTokenType tokenType = TokenType;

            if (tokenType != RdnTokenType.StartArray)
            {
                ThrowHelper.ThrowRdnElementWrongTypeException(RdnTokenType.StartArray, tokenType);
            }
        ...
        /// <summary>
        ///   Get an enumerator to enumerate the values in the RDN Set represented by this RdnElement.
        /// </summary>
        /// <returns>
        ///   An enumerator to enumerate the values in the RDN Set represented by this RdnElement.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Set"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public ArrayEnumerator EnumerateSet()
        {
            ...
            if (tokenType != RdnTokenType.StartSet)
            {
                ThrowHelper.ThrowRdnElementWrongTypeException(RdnTokenType.StartSet, tokenType);
            }
        ...
        /// <summary>
        ///   Get an enumerator to enumerate the entries in the RDN Map represented by this RdnElement.
        ...
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Map"/>.
        /// </exception>
        /// <exception cref="ObjectDisposedException">
        ///   The parent <see cref="RdnDocument"/> has been disposed.
        /// </exception>
        public ArrayEnumerator EnumerateMap()
        {
            ...
            if (tokenType != RdnTokenType.StartMap)
            {
                ThrowHelper.ThrowRdnElementWrongTypeException(RdnTokenType.StartMap, tokenType);
            }
        ...
        /// <summary>
        ///   Get an enumerator to enumerate the properties in the RDN object represented by this RdnElement.
        /// </summary>
        /// <returns>
        ///   An enumerator to enumerate the properties in the RDN object represented by this RdnElement.
        /// </returns>
        /// <exception cref="InvalidOperationException">
        ///   This value's <see cref="ValueKind"/> is not <see cref="RdnValueKind.Object"/>.
        /// </exception>
        ...
        public ObjectEnumerator EnumerateObject()
        {
            ...
            {
                ThrowHelper.ThrowRdnElementWrongTypeException(RdnTokenType.StartObject, tokenType);
            }
        ...
        /// <remarks>
        ///   <para>
        ///     For RdnElement built from <see cref="RdnDocument"/>:
        ///   </para>
        ///
        ///   <para>
        ///     For <see cref="RdnValueKind.Null"/>, <see cref="string.Empty"/> is returned.
        ///   </para>
        ///
        ///   <para>
        ///     For <see cref="RdnValueKind.True"/>, <see cref="bool.TrueString"/> is returned.
        ///   </para>
        ///
        ///   <para>
        ///     For <see cref="RdnValueKind.False"/>, <see cref="bool.FalseString"/> is returned.
        ///   </para>
        ///
        ///   <para>
        ///     For <see cref="RdnValueKind.String"/>, the value of <see cref="GetString"/>() is returned.
        ///   </para>
        ///
        ///   <para>
        ...
        public override string ToString()
        {
            switch (TokenType)
            {
                ...
                case RdnTokenType.Comment:
                case RdnTokenType.EndArray:
                case RdnTokenType.EndObject:
                default:
                    Debug.Fail($"No handler for {nameof(RdnTokenType)}.{TokenType}");
                    return string.Empty;
            }
        }

        /// <summary>
        ///   Get a RdnElement which can be safely stored beyond the lifetime of the
        ///   original <see cref="RdnDocument"/>.
        /// </summary>
        /// <returns>
        ///   A RdnElement which can be safely stored beyond the lifetime of the
        ///   original <see cref="RdnDocument"/>.
        /// </returns>
        /// <remarks>
        ///   <para>
        ///     If this RdnElement is itself the output of a previous call to Clone, or
        ///     a value contained within another RdnElement which was the output of a previous
        ///     call to Clone, this method results in no additional memory allocation.
        ///   </para>
        /// </remarks>
        public RdnElement Clone()
        {
            CheckValidInstance();
