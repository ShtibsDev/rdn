...
namespace Rdn.Serialization
{
        ...
        where TReadBufferState : struct, IReadBufferState<TReadBufferState, TStream>
    {
        ...
        public abstract void Read(TStream utf8Rdn);

        public abstract void Advance(long bytesConsumed);

        // This would normally be implemented as returning a Utf8RdnReader, but this pattern hits a limitation
        ...
        public abstract void GetReader(RdnReaderState rdnReaderState, out Utf8RdnReader reader);
    }
}
