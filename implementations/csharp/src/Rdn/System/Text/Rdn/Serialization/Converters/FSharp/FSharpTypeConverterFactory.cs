...
using FSharpKind = Rdn.Serialization.Metadata.FSharpCoreReflectionProxy.FSharpKind;

namespace Rdn.Serialization.Converters
{
    [RequiresDynamicCode(FSharpCoreReflectionProxy.FSharpCoreUnreferencedCodeMessage)]
    internal sealed class FSharpTypeConverterFactory : RdnConverterFactory
    {
        ...
        public override RdnConverter? CreateConverter(Type typeToConvert, RdnSerializerOptions options)
        {
            ...
            return (RdnConverter)Activator.CreateInstance(converterFactoryType, constructorArguments)!;
        }
    }
}
