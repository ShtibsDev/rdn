...
namespace Rdn.Serialization
{
    ...
    /// </summary>
    public abstract partial class RdnConverter
    {
        internal RdnConverter()
        {
            IsInternalConverter = GetType().Assembly == typeof(RdnConverter).Assembly;
        ...
        /// </summary>
        /// <remarks>
        /// For instances of type <see cref="RdnConverter{T}"/> returns typeof(T),
        /// and for instances of type <see cref="RdnConverterFactory"/> returns <see langword="null" />.
        /// </remarks>
        ...
        /// <summary>
        /// Indicates that the converter can consume the <see cref="RdnTypeInfo.CreateObject"/> delegate.
        ...
        /// <summary>
        /// Indicates that the converter is compatible with <see cref="RdnObjectCreationHandling.Populate"/>.
        /// </summary>
        ...
        /// <summary>
        /// The serializer must read ahead all contents of the next RDN value
        ...
        internal virtual RdnTypeInfo CreateRdnTypeInfo(RdnSerializerOptions options)
        {
            Debug.Fail("Should not be reachable.");
        ...
        internal RdnConverter<TTarget> CreateCastingConverter<TTarget>()
        {
            Debug.Assert(this is not RdnConverterFactory);

            if (this is RdnConverter<TTarget> conv)
            {
                return conv;
            }
            else
            {
                RdnSerializerOptions.CheckConverterNullabilityIsSameAsPropertyType(this, typeof(TTarget));
        ...
        /// <summary>
        /// Tracks whether the RdnConverter&lt;T&gt;.HandleNull property has been overridden by a derived converter.
        /// </summary>
        ...
        /// When RdnConverter&lt;T&gt;.HandleNull isn't overridden this can still be true for non-nullable structs.
        /// </summary>
        internal bool HandleNullOnRead { get; private protected init; }

        /// <summary>
        /// Does the converter want to be called for null values.
        /// Should always match the precise value of the RdnConverter&lt;T&gt;.HandleNull virtual property.
        /// </summary>
        ...
        /// </summary>
        internal virtual RdnConverter? SourceConverterForCastingConverter => null;

        internal virtual Type? ElementType => null;

        internal virtual Type? KeyType => null;

        internal virtual RdnConverter? NullableElementConverter => null;
        ...
        /// Used in conjunction with <see cref="RdnCollectionConverter{TCollection, TElement}.ConvertCollection(ref ReadStack, RdnSerializerOptions)"/>.
        /// </summary>
        internal virtual bool IsConvertibleCollection => false;

        internal static bool ShouldFlush(ref WriteStack state, Utf8RdnWriter writer)
        {
        ...
        internal abstract object? ReadAsObject(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options);
        internal abstract bool OnTryReadAsObject(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options, scoped ref ReadStack state, out object? value);
        internal abstract bool TryReadAsObject(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options, scoped ref ReadStack state, out object? value);
        internal abstract object? ReadAsPropertyNameAsObject(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options);
        internal abstract object? ReadAsPropertyNameCoreAsObject(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options);
        internal abstract object? ReadNumberWithCustomHandlingAsObject(ref Utf8RdnReader reader, RdnNumberHandling handling, RdnSerializerOptions options);

        internal abstract void WriteAsObject(Utf8RdnWriter writer, object? value, RdnSerializerOptions options);
        internal abstract bool OnTryWriteAsObject(Utf8RdnWriter writer, object? value, RdnSerializerOptions options, ref WriteStack state);
        internal abstract bool TryWriteAsObject(Utf8RdnWriter writer, object? value, RdnSerializerOptions options, ref WriteStack state);
        ...
        /// <summary>
        /// Used for hooking custom configuration to a newly created associated RdnTypeInfo instance.
        /// </summary>
        internal virtual void ConfigureRdnTypeInfo(RdnTypeInfo rdnTypeInfo, RdnSerializerOptions options) { }
        ...
        internal virtual void ConfigureRdnTypeInfoUsingReflection(RdnTypeInfo rdnTypeInfo, RdnSerializerOptions options) { }
    }
}
