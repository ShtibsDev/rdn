...
{
    internal sealed class Int128Converter : RdnPrimitiveConverter<Int128>
    {
        ...
        public override Int128 Read(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options)
        {
        ...
        public override void Write(Utf8RdnWriter writer, Int128 value, RdnSerializerOptions options)
        {
            if (options?.NumberHandling is not null and not RdnNumberHandling.Strict)
            {
        ...
        private static Int128 ReadCore(ref Utf8RdnReader reader)
        {
        ...
        private static void WriteCore(Utf8RdnWriter writer, Int128 value)
        {
        ...
        internal override Int128 ReadAsPropertyNameCore(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options)
        {
            Debug.Assert(reader.TokenType == RdnTokenType.PropertyName);
            return ReadCore(ref reader);
        }

        internal override void WriteAsPropertyNameCore(Utf8RdnWriter writer, Int128 value, RdnSerializerOptions options, bool isWritingExtensionDataProperty)
        {
            Span<byte> buffer = stackalloc byte[MaxFormatLength];
            Format(buffer, value, out int written);
        ...
        internal override Int128 ReadNumberWithCustomHandling(ref Utf8RdnReader reader, RdnNumberHandling handling, RdnSerializerOptions options)
        {
        ...
        internal override void WriteNumberWithCustomHandling(Utf8RdnWriter writer, Int128 value, RdnNumberHandling handling)
        {
