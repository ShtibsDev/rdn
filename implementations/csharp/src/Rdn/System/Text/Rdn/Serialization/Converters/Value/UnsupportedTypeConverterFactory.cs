...
namespace Rdn.Serialization.Converters
{
    ...
    internal sealed class UnsupportedTypeConverterFactory : RdnConverterFactory
    {
        ...
        internal static RdnConverter CreateUnsupportedConverterForType(Type type, string? errorMessage = null)
        {
