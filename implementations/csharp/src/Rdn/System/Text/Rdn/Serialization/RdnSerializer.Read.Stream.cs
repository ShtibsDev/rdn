...
namespace Rdn
{
    public static partial class RdnSerializer
    {
            ...
            RdnSerializerOptions? options = null)
        {
            ...
            RdnTypeInfo<TValue> rdnTypeInfo = GetTypeInfo<TValue>(options);
            return rdnTypeInfo.Deserialize(utf8Rdn);
        }
            ...
            RdnSerializerOptions? options = null)
        {
            ...
            RdnTypeInfo rdnTypeInfo = GetTypeInfo(options, returnType);
            return rdnTypeInfo.DeserializeAsObject(utf8Rdn);
        }
        ...
        /// When <paramref name="topLevelValues"/> is set to <see langword="false" />, treats the stream as a RDN array and
