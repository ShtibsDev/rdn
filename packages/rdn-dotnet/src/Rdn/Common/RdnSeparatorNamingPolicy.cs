...
namespace Rdn
{
    internal abstract class RdnSeparatorNamingPolicy : RdnNamingPolicy
    {
        private readonly bool _lowercase;
        private readonly char _separator;

        internal RdnSeparatorNamingPolicy(bool lowercase, char separator)
        {
        ...
        private static string ConvertNameCore(char separator, bool lowercase, ReadOnlySpan<char> chars)
        {
            ...
            Span<char> destination = initialBufferLength <= RdnConstants.StackallocCharThreshold
