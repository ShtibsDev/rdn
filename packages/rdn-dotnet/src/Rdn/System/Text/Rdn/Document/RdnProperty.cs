...
{
    /// <summary>
    ///   Represents a single property for a RDN object.
    /// </summary>
    [DebuggerDisplay("{DebuggerDisplay,nq}")]
    public readonly struct RdnProperty
    {
        /// <summary>
        ///   The value of this property.
        /// </summary>
        public RdnElement Value { get; }

        internal RdnProperty(RdnElement value)
        {
            Value = value;
        }
        ...
        ///   This value's <see cref="Type"/> is not <see cref="RdnTokenType.PropertyName"/>.
        /// </exception>
        /// <remarks>
        ...
        /// <summary>
        ///   Write the property into the provided writer as a named RDN object property.
        /// </summary>
        ...
        ///   This <see cref="Name"/>'s length is too large to be a RDN object property.
        /// </exception>
        /// <exception cref="InvalidOperationException">
        ///   This <see cref="Value"/>'s <see cref="RdnElement.ValueKind"/> would result in an invalid RDN.
        /// </exception>
        ...
        private string DebuggerDisplay
            => Value.ValueKind == RdnValueKind.Undefined ? "<Undefined>" : $"\"{ToString()}\"";
    }
}
