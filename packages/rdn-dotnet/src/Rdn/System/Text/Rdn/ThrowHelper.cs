...
using static Rdn.Utf8RdnWriter;

namespace Rdn
{
    internal static partial class ThrowHelper
    {
        // If the exception source is this value, the serializer will re-throw as RdnException.
        public const string ExceptionSourceValueToRethrowAsRdnException = "System.Text.Rdn.Rethrowable";
        ...
        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException_RdnNumberExponentTooLarge(string parameterName)
        {
            throw GetArgumentOutOfRangeException(parameterName, SR.RdnNumberExponentTooLarge);
        }
        ...
        [DoesNotReturn]
        public static void ThrowArgumentOutOfRangeException_RdnConverterFactory_TypeNotSupported(Type typeToConvert)
        {
        ...
        public static void ThrowArgumentException(ReadOnlySpan<byte> propertyName, ReadOnlySpan<byte> value)
        {
            ...
            {
                Debug.Assert(value.Length > RdnConstants.MaxUnescapedTokenSize);
        ...
        public static void ThrowArgumentException(ReadOnlySpan<byte> propertyName, ReadOnlySpan<char> value)
        {
            ...
            {
                Debug.Assert(value.Length > RdnConstants.MaxCharacterTokenSize);
                ThrowArgumentException(SR.Format(SR.ValueTooLarge, value.Length));
            }
        }
        ...
        {
            currentDepth &= RdnConstants.RemoveFlagsBitMask;
            ...
            {
                Debug.Assert(propertyName.Length > RdnConstants.MaxCharacterTokenSize);
                ThrowArgumentException(SR.Format(SR.PropertyNameTooLarge, propertyName.Length));
            }
        }
        ...
        {
            return new InvalidOperationException(message) { Source = ExceptionSourceValueToRethrowAsRdnException };
        }

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_DepthNonZeroOrEmptyRdn(int currentDepth)
        {
        ...
        private static InvalidOperationException GetInvalidOperationException(int currentDepth)
        {
            ...
            {
                return GetInvalidOperationException(SR.EmptyRdnIsInvalid);
            }
        }
        ...
        public static InvalidOperationException GetInvalidOperationException_ExpectedArray(RdnTokenType tokenType)
        {
            return GetInvalidOperationException("array", tokenType);
        }

        public static InvalidOperationException GetInvalidOperationException_ExpectedObject(RdnTokenType tokenType)
        {
            return GetInvalidOperationException("object", tokenType);
        }

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ExpectedNumber(RdnTokenType tokenType)
        {
            throw GetInvalidOperationException("number", tokenType);
        }

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ExpectedBoolean(RdnTokenType tokenType)
        {
            throw GetInvalidOperationException("boolean", tokenType);
        }

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ExpectedString(RdnTokenType tokenType)
        {
            throw GetInvalidOperationException("string", tokenType);
        }

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ExpectedPropertyName(RdnTokenType tokenType)
        {
            throw GetInvalidOperationException("propertyName", tokenType);
        }

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ExpectedStringComparison(RdnTokenType tokenType)
        {
            throw GetInvalidOperationException(tokenType);
        }

        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ExpectedComment(RdnTokenType tokenType)
        {
        ...
        private static InvalidOperationException GetInvalidOperationException(string message, RdnTokenType tokenType)
        {
            return GetInvalidOperationException(SR.Format(SR.InvalidCast, tokenType, message));
        }

        private static InvalidOperationException GetInvalidOperationException(RdnTokenType tokenType)
        {
            return GetInvalidOperationException(SR.Format(SR.InvalidComparison, tokenType));
        }

        [DoesNotReturn]
        internal static void ThrowRdnElementWrongTypeException(
            RdnTokenType expectedType,
            RdnTokenType actualType)
        {
            throw GetRdnElementWrongTypeException(expectedType.ToValueKind(), actualType.ToValueKind());
        }

        internal static InvalidOperationException GetRdnElementWrongTypeException(
            RdnValueKind expectedType,
            RdnValueKind actualType)
        {
            return GetInvalidOperationException(
                SR.Format(SR.RdnElementHasWrongType, expectedType, actualType));
        }
        ...
        {
            return GetInvalidOperationException(
                SR.Format(SR.RdnElementHasWrongType, expectedTypeName, actualType));
        }

        [DoesNotReturn]
        public static void ThrowRdnReaderException(ref Utf8RdnReader rdn, ExceptionResource resource, byte nextByte = default, ReadOnlySpan<byte> bytes = default)
        {
            throw GetRdnReaderException(ref rdn, resource, nextByte, bytes);
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static RdnException GetRdnReaderException(ref Utf8RdnReader rdn, ExceptionResource resource, byte nextByte, ReadOnlySpan<byte> bytes)
        {
            string message = GetResourceString(ref rdn, resource, nextByte, Encoding.UTF8.GetString(bytes));

            long lineNumber = rdn.CurrentState._lineNumber;
            long bytePositionInLine = rdn.CurrentState._bytePositionInLine;

            message += $" LineNumber: {lineNumber} | BytePositionInLine: {bytePositionInLine}.";
            return new RdnReaderException(message, lineNumber, bytePositionInLine);
        }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static string GetResourceString(ref Utf8RdnReader rdn, ExceptionResource resource, byte nextByte, string characters)
        {
            ...
            switch (resource)
            {
                case ExceptionResource.ArrayDepthTooLarge:
                    message = SR.Format(SR.ArrayDepthTooLarge, rdn.CurrentState.Options.MaxDepth);
                    break;
                ...
                case ExceptionResource.RequiredDigitNotFoundEndOfData:
                    ...
                    break;
                case ExceptionResource.ExpectedEndAfterSingleRdn:
                    message = SR.Format(SR.ExpectedEndAfterSingleRdn, character);
                    break;
                ...
                case ExceptionResource.FoundInvalidCharacter:
                    ...
                    break;
                case ExceptionResource.InvalidEndOfRdnNonPrimitive:
                    message = SR.Format(SR.InvalidEndOfRdnNonPrimitive, rdn.TokenType);
                    break;
                case ExceptionResource.ObjectDepthTooLarge:
                    message = SR.Format(SR.ObjectDepthTooLarge, rdn.CurrentState.Options.MaxDepth);
                    break;
                ...
                case ExceptionResource.ZeroDepthAtEnd:
                    ...
                    break;
                case ExceptionResource.ExpectedRdnTokens:
                    message = SR.ExpectedRdnTokens;
                    break;
        ...
        [DoesNotReturn]
        public static void ThrowInvalidOperationException(ExceptionResource resource, int currentDepth, int maxDepth, byte token, RdnTokenType tokenType)
        {
        ...
        public static InvalidOperationException GetInvalidOperationException(string message, Exception? innerException)
        {
            ...
            ex.Source = ExceptionSourceValueToRethrowAsRdnException;
            return ex;
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        public static InvalidOperationException GetInvalidOperationException(ExceptionResource resource, int currentDepth, int maxDepth, byte token, RdnTokenType tokenType)
        {
        ...
        // This function will convert an ExceptionResource enum value to the resource string.
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static string GetResourceString(ExceptionResource resource, int currentDepth, int maxDepth, byte token, RdnTokenType tokenType)
        {
            string message = "";
            switch (resource)
            {
                case ExceptionResource.MismatchedObjectArray:
                    Debug.Assert(token == RdnConstants.CloseBracket || token == RdnConstants.CloseBrace);
                    message = (tokenType == RdnTokenType.PropertyName) ?
                ...
                case ExceptionResource.DepthTooLarge:
                    message = SR.Format(SR.DepthTooLarge, currentDepth & RdnConstants.RemoveFlagsBitMask, maxDepth);
                    break;
        ...
        {
            throw new FormatException { Source = ExceptionSourceValueToRethrowAsRdnException };
        }
        ...
        public static void ThrowFormatException(NumericType numericType)
        {
            ...
            throw new FormatException(message) { Source = ExceptionSourceValueToRethrowAsRdnException };
        }
        ...
        [DoesNotReturn]
        public static void ThrowInvalidOperationException_ExpectedChar(RdnTokenType tokenType)
        {
            throw GetInvalidOperationException("char", tokenType);
        }

        [DoesNotReturn]
        public static void ThrowObjectDisposedException_Utf8RdnWriter()
        {
            throw new ObjectDisposedException(nameof(Utf8RdnWriter));
        }

        [DoesNotReturn]
        public static void ThrowObjectDisposedException_RdnDocument()
        {
            throw new ObjectDisposedException(nameof(RdnDocument));
        }

        [DoesNotReturn]
        public static void ThrowInsufficientExecutionStackException_RdnElementDeepEqualsInsufficientExecutionStack()
        {
            throw new InsufficientExecutionStackException(SR.RdnElementDeepEqualsInsufficientExecutionStack);
        }
    }
