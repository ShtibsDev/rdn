...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Reads one RDN value (including objects or arrays) from the provided reader into a <typeparamref name="TValue"/>.
        /// </summary>
        ...
        public static TValue? Deserialize<TValue>(ref Utf8RdnReader reader, RdnSerializerOptions? options = null)
        {
            RdnTypeInfo<TValue> rdnTypeInfo = GetTypeInfo<TValue>(options);
            return Read<TValue>(ref reader, rdnTypeInfo);
        }
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        [RequiresDynamicCode(SerializationRequiresDynamicCodeMessage)]
        public static object? Deserialize(ref Utf8RdnReader reader, Type returnType, RdnSerializerOptions? options = null)
        {
        ...
        ///   </para>
        /// </remarks>
        public static TValue? Deserialize<TValue>(ref Utf8RdnReader reader, RdnTypeInfo<TValue> rdnTypeInfo)
        {
            ArgumentNullException.ThrowIfNull(rdnTypeInfo);

            rdnTypeInfo.EnsureConfigured();
            return Read(ref reader, rdnTypeInfo);
        }

        /// <summary>
        /// Reads one RDN value (including objects or arrays) from the provided reader into an instance specified by the <paramref name="rdnTypeInfo"/>.
        /// </summary>
        ...
        /// <exception cref="RdnException">
        /// The RDN is invalid,
        /// <paramref name="rdnTypeInfo"/> is not compatible with the RDN,
        /// or a value could not be read from the reader.
        /// </exception>
        /// <exception cref="ArgumentException">
        ///   <paramref name="reader"/> is using unsupported options.
        ...
        ///   </para>
        /// </remarks>
        public static object? Deserialize(ref Utf8RdnReader reader, RdnTypeInfo rdnTypeInfo)
        {
            ArgumentNullException.ThrowIfNull(rdnTypeInfo);
        ...
        private static TValue? Read<TValue>(ref Utf8RdnReader reader, RdnTypeInfo<TValue> rdnTypeInfo)
        {
            ...
            try
            {
                Utf8RdnReader scopedReader = GetReaderScopedToNextValue(ref reader, ref state);
                return rdnTypeInfo.Deserialize(ref scopedReader, ref state);
            }
            catch (RdnException)
            {
                reader = restore;
        ...
        private static object? ReadAsObject(ref Utf8RdnReader reader, RdnTypeInfo rdnTypeInfo)
        {
            ...
            {
                Utf8RdnReader scopedReader = GetReaderScopedToNextValue(ref reader, ref state);
                return rdnTypeInfo.DeserializeAsObject(ref scopedReader, ref state);
            }
            catch (RdnException)
            {
                reader = restore;
        ...
        private static Utf8RdnReader GetReaderScopedToNextValue(ref Utf8RdnReader reader, scoped ref ReadStack state)
        {
            // Advances the provided reader, validating that it is pointing to a complete RDN value.
            // If successful, returns a new Utf8RdnReader that is scoped to the next value, reusing existing buffers.
            ...
            try
            {
                    ...
                    case RdnTokenType.PropertyName:
                        {
                            if (!reader.Read())
                            {
                                ThrowHelper.ThrowRdnReaderException(ref reader, ExceptionResource.ExpectedOneCompleteToken);
                            }
                            break;
                        }
                }
                ...
                switch (reader.TokenType)
                {
                    ...
                    case RdnTokenType.StartArray:
                        ...
                        if (!reader.TrySkip())
                        {
                            ThrowHelper.ThrowRdnReaderException(ref reader, ExceptionResource.NotEnoughData);
                        }
                        ...
                        Debug.Assert(reader.TokenType is RdnTokenType.EndObject or RdnTokenType.EndArray);
                        break;
            ...
            return valueSpan.IsEmpty
                ? new Utf8RdnReader(valueSequence, reader.CurrentState.Options)
                : new Utf8RdnReader(valueSpan, reader.CurrentState.Options);
        }
    }
}
