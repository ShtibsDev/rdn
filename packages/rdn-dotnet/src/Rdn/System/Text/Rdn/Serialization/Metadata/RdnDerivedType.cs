...
namespace Rdn.Serialization.Metadata
{
    ...
    /// </summary>
    public readonly struct RdnDerivedType
    {
        /// <summary>
        ...
        public RdnDerivedType(Type derivedType)
        {
        ...
        public RdnDerivedType(Type derivedType, int typeDiscriminator)
        {
            DerivedType = derivedType;
        ...
        /// <param name="derivedType">The derived type to be supported by the polymorphic type metadata.</param>
        /// <param name="typeDiscriminator">The type discriminator to be associated with the derived type.</param>
        public RdnDerivedType(Type derivedType, string typeDiscriminator)
        {
            DerivedType = derivedType;
            TypeDiscriminator = typeDiscriminator;
        }

        internal RdnDerivedType(Type derivedType, object? typeDiscriminator)
        {
