...
using FoundProperties = System.ValueTuple<Rdn.Serialization.Metadata.RdnPropertyInfo, Rdn.RdnReaderState, long, byte[]?, string?>;
using FoundPropertiesAsync = System.ValueTuple<Rdn.Serialization.Metadata.RdnPropertyInfo, object?, string?>;
...
namespace Rdn
{
    ...
    internal sealed class ArgumentState
    {
        ...
        public RdnParameterInfo? RdnParameterInfo;
    }
}
