...
namespace Rdn.Serialization.Metadata
{
    ...
    public sealed class RdnObjectInfoValues<T>
    {
        /// <summary>
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Rdn source generator and should not be called directly.</remarks>
        public Func<RdnSerializerContext, RdnPropertyInfo[]>? PropertyMetadataInitializer { get; init; }
        ...
        /// </summary>
        /// <remarks>This API is for use by the output of the Rdn source generator and should not be called directly.</remarks>
        public Func<RdnParameterInfoValues[]>? ConstructorParameterMetadataInitializer { get; init; }
        ...
        /// <summary>
        /// Provides a serialization implementation for instances of the class or struct which assumes options specified by <see cref="RdnSourceGenerationOptionsAttribute"/>.
        /// </summary>
        /// <remarks>This API is for use by the output of the Rdn source generator and should not be called directly.</remarks>
        public Action<Utf8RdnWriter, T>? SerializeHandler { get; init; }
    }
}
