...
namespace Rdn
{
    public static partial class RdnSerializer
    {
        ...
        public static RdnElement SerializeToElement<TValue>(TValue value, RdnSerializerOptions? options = null)
        {
            RdnTypeInfo<TValue> rdnTypeInfo = GetTypeInfo<TValue>(options);
            return WriteElement(value, rdnTypeInfo);
        }
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        [RequiresDynamicCode(SerializationRequiresDynamicCodeMessage)]
        public static RdnElement SerializeToElement(object? value, Type inputType, RdnSerializerOptions? options = null)
        {
        ...
        /// </exception>
        public static RdnElement SerializeToElement<TValue>(TValue value, RdnTypeInfo<TValue> rdnTypeInfo)
        {
        ...
        /// </exception>
        public static RdnElement SerializeToElement(object? value, RdnTypeInfo rdnTypeInfo)
        {
            ArgumentNullException.ThrowIfNull(rdnTypeInfo);
        ...
        private static RdnElement WriteElement<TValue>(in TValue value, RdnTypeInfo<TValue> rdnTypeInfo)
        {
            ...
            try
            {
                ...
                return RdnElement.Parse(output.WrittenSpan, options.GetDocumentOptions());
            }
            finally
            {
        ...
        private static RdnElement WriteElementAsObject(object? value, RdnTypeInfo rdnTypeInfo)
        {
            RdnSerializerOptions options = rdnTypeInfo.Options;
