...
namespace Rdn.Serialization.Metadata
{
    internal abstract class MemberAccessor
    {
        ...
        public abstract RdnTypeInfo.ParameterizedConstructorDelegate<T, TArg0, TArg1, TArg2, TArg3>? CreateParameterizedConstructor<T, TArg0, TArg1, TArg2, TArg3>(ConstructorInfo constructor);
