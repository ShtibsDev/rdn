...
namespace Rdn.Serialization.Converters
{
        ...
        where TCollection : IList
    {
        ...
        protected override bool OnWriteResume(Utf8RdnWriter writer, TCollection value, RdnSerializerOptions options, ref WriteStack state)
        {
            ...
            RdnConverter<object?> elementConverter = GetElementConverter(ref state);
        ...
        internal override void ConfigureRdnTypeInfo(RdnTypeInfo rdnTypeInfo, RdnSerializerOptions options)
        {
            ...
            if (rdnTypeInfo.CreateObject is null && Type.IsAssignableFrom(typeof(List<object?>)))
            {
                Debug.Assert(Type.IsInterface);
                rdnTypeInfo.CreateObject = () => new List<object?>();
            }
        }
    }
}
