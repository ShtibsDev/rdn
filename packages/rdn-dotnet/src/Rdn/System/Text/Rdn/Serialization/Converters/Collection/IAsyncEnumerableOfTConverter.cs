...
namespace Rdn.Serialization.Converters
{
    internal sealed class IAsyncEnumerableOfTConverter<TAsyncEnumerable, TElement>
        : RdnCollectionConverter<TAsyncEnumerable, TElement>
        where TAsyncEnumerable : IAsyncEnumerable<TElement>
    {
        internal override bool OnTryRead(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options, scoped ref ReadStack state, out TAsyncEnumerable value)
        {
        ...
        internal override bool OnTryWrite(Utf8RdnWriter writer, TAsyncEnumerable value, RdnSerializerOptions options, ref WriteStack state)
        {
        ...
        protected override bool OnWriteResume(Utf8RdnWriter writer, TAsyncEnumerable value, RdnSerializerOptions options, ref WriteStack state)
        {
