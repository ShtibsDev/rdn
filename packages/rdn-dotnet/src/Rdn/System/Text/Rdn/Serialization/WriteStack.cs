...
namespace Rdn
{
    ...
    internal struct WriteStack
    {
        ...
        /// <summary>
        /// Gets the nested RdnTypeInfo before resolving any polymorphic converters
        /// </summary>
        ...
        public void Push()
        {
            ...
            if (_continuationCount == 0)
            {
                ...
                {
                    RdnTypeInfo rdnTypeInfo = Current.GetNestedRdnTypeInfo();
        ...
        // Return a property path as a simple RDNPath using dot-notation when possible. When special characters are present, bracket-notation is used:
        // $.x.y.z
        ...
        public string PropertyPath()
        {
            ...
            {
                // Append the property name. Or attempt to get the RDN property name from the property name specified in re-entry.
                string? propertyName =
                    frame.RdnPropertyInfo?.MemberName ??
                    frame.RdnPropertyNameAsString;
        ...
        private string DebuggerDisplay => $"Path = {PropertyPath()} Current = ConverterStrategy.{Current.RdnPropertyInfo?.EffectiveConverter.ConverterStrategy}, {Current.RdnTypeInfo?.Type.Name}";
    }
}
