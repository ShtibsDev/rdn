...
namespace Rdn.Serialization.Converters
{
    ...
    internal sealed class EnumConverterFactory : RdnConverterFactory
    {
        ...
        public override RdnConverter CreateConverter(Type type, RdnSerializerOptions options)
        {
        ...
        public static RdnConverter Create(Type enumType, EnumConverterOptions converterOptions, RdnNamingPolicy? namingPolicy, RdnSerializerOptions options)
        {
            if (!Helpers.IsSupportedTypeCode(Type.GetTypeCode(enumType)))
            {
                // Char-backed enums are valid in IL and F# but are not supported by Rdn.
            ...
            return (RdnConverter)converterType.CreateInstanceNoWrapExceptions(
                parameterTypes: [typeof(EnumConverterOptions), typeof(RdnNamingPolicy), typeof(RdnSerializerOptions)],
        ...
        internal static class Helpers
        {
            ...
            public static RdnConverter<T> Create<T>(EnumConverterOptions converterOptions, RdnSerializerOptions options, RdnNamingPolicy? namingPolicy = null)
                where T : struct, Enum
            {
