...
namespace Rdn
{
    public static partial class RdnSerializer
    {
        ...
        internal static readonly RdnEncodedText s_metadataId = RdnEncodedText.Encode(IdPropertyName, encoder: null);
        internal static readonly RdnEncodedText s_metadataRef = RdnEncodedText.Encode(RefPropertyName, encoder: null);
        internal static readonly RdnEncodedText s_metadataType = RdnEncodedText.Encode(TypePropertyName, encoder: null);
        internal static readonly RdnEncodedText s_metadataValues = RdnEncodedText.Encode(ValuesPropertyName, encoder: null);

        internal static MetadataPropertyName WriteMetadataForObject(
            RdnConverter rdnConverter,
            ref WriteStack state,
            Utf8RdnWriter writer)
        {
            Debug.Assert(rdnConverter.CanHaveMetadata);
            ...
            if (state.PolymorphicTypeDiscriminator is object discriminator)
            {
                ...
                RdnEncodedText propertyName =
                    state.PolymorphicTypeResolver.CustomTypeDiscriminatorPropertyNameRdnEncoded is RdnEncodedText customPropertyName
                    ? customPropertyName
                    : s_metadataType;
        ...
        internal static MetadataPropertyName WriteMetadataForCollection(
            ...
            Utf8RdnWriter writer)
        {
            // For collections with metadata, we nest the array payload within a RDN object.
            writer.WriteStartObject();
            MetadataPropertyName writtenMetadata = WriteMetadataForObject(rdnConverter, ref state, writer);
        ...
        /// </summary>
        internal static bool TryGetReferenceForValue(object currentValue, ref WriteStack state, Utf8RdnWriter writer)
        {
