...
{
    /// <summary>
    /// Provides RDN serialization-related metadata about a constructor parameter.
    /// </summary>
    public abstract class RdnParameterInfo
    {
        internal RdnParameterInfo(RdnParameterInfoValues parameterInfoValues, RdnPropertyInfo matchingProperty)
        {
        ...
        ///
        /// This setting is in sync with the associated <see cref="RdnPropertyInfo.IsSetNullable"/> property.
        /// </remarks>
        ...
        internal RdnPropertyInfo MatchingProperty { get; }

        internal RdnConverter EffectiveConverter => MatchingProperty.EffectiveConverter;
        internal bool IgnoreNullTokensOnRead => MatchingProperty.IgnoreNullTokensOnRead;
        internal RdnSerializerOptions Options => MatchingProperty.Options;

        // The effective name of the parameter as UTF-8 bytes.
        internal byte[] RdnNameAsUtf8Bytes => MatchingProperty.NameAsUtf8Bytes;
        internal RdnNumberHandling? NumberHandling => MatchingProperty.EffectiveNumberHandling;
        internal RdnTypeInfo RdnTypeInfo => MatchingProperty.RdnTypeInfo;
