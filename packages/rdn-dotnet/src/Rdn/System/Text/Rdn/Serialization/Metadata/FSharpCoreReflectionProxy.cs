...
namespace Rdn.Serialization.Metadata
{
    ...
    // Every F# application ships with a copy of FSharp.Core, however it is not available statically to Rdn.
    ...
    /// <summary>
    /// Proxy class used to access FSharp.Core metadata and reflection APIs that are not statically available to Rdn.
    /// </summary>
    internal sealed class FSharpCoreReflectionProxy
    {
        /// <summary>
        /// The various categories of F# types that Rdn supports.
        /// </summary>
