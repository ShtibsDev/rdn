...
{
    /// <summary>
    /// Converts an object or value to or from RDN.
    /// </summary>
    /// <typeparam name="T">The <see cref="System.Type"/> to convert.</typeparam>
    public abstract partial class RdnConverter<T> : RdnConverter
    {
        /// <summary>
        /// When overridden, constructs a new <see cref="RdnConverter{T}"/> instance.
        /// </summary>
        protected internal RdnConverter()
        {
        ...
        internal sealed override RdnTypeInfo CreateRdnTypeInfo(RdnSerializerOptions options)
        {
            return new RdnTypeInfo<T>(this, options);
        }

        /// <summary>
        /// Indicates whether <see langword="null"/> should be passed to the converter on serialization,
        /// and whether <see cref="RdnTokenType.Null"/> should be passed on deserialization.
        /// </summary>
        /// <remarks>
        ...
        {
            T valueOfT = RdnSerializer.UnboxOnWrite<T>(value)!;
            Write(writer, valueOfT, options);
        }

        // This non-generic API is sealed as it just forwards to the generic version.
        internal sealed override bool OnTryWriteAsObject(Utf8RdnWriter writer, object? value, RdnSerializerOptions options, ref WriteStack state)
        {
            T valueOfT = RdnSerializer.UnboxOnWrite<T>(value)!;
        ...
        internal sealed override void WriteAsPropertyNameCoreAsObject(Utf8RdnWriter writer, object? value, RdnSerializerOptions options, bool isWritingExtensionDataProperty)
        {
            T valueOfT = RdnSerializer.UnboxOnWrite<T>(value)!;
        ...
        // This non-generic API is sealed as it just forwards to the generic version.
        internal sealed override bool TryWriteAsObject(Utf8RdnWriter writer, object? value, RdnSerializerOptions options, ref WriteStack state)
        {
            T valueOfT = RdnSerializer.UnboxOnWrite<T>(value)!;
        ...
        internal virtual bool OnTryWrite(Utf8RdnWriter writer,
...
#nullable enable
        ...
        // Provide a default implementation for value converters.
        internal virtual bool OnTryRead(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options, scoped ref ReadStack state, out T? value)
        {
        ...
        /// <summary>
        /// Read and convert the RDN to T.
        /// </summary>
        /// <remarks>
        /// A converter may throw any Exception, but should throw <cref>RdnException</cref> when the RDN is invalid.
        /// </remarks>
        /// <param name="reader">The <see cref="Utf8RdnReader"/> to read from.</param>
        ...
        /// <remarks>Note that the value of <seealso cref="HandleNull"/> determines if the converter handles null RDN tokens.</remarks>
        public abstract T? Read(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options);

        internal bool TryRead(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options, scoped ref ReadStack state, out T? value, out bool isPopulatedValue)
        {
            // For perf and converter simplicity, handle null here instead of forwarding to the converter.
            if (reader.TokenType == RdnTokenType.Null && !HandleNullOnRead && !state.IsContinuation)
            {
...
#endif
                {
                    RdnTokenType originalPropertyTokenType = reader.TokenType;
            ...
            RdnPropertyInfo? propertyInfo = state.Current.RdnPropertyInfo;
...
#endif
            state.Push();
            Debug.Assert(Type == state.Current.RdnTypeInfo.Type);

            if (!isContinuation)
            {
#if DEBUG
                // For performance, only perform token type validation of converters on debug builds.
                Debug.Assert(state.Current.OriginalTokenType == RdnTokenType.None);
            ...
            if (success)
            {
                if (state.IsContinuation)
                {
                    ...
                    ThrowHelper.ThrowRdnException_SerializationConverterRead(this);
                }
        ...
        internal sealed override bool OnTryReadAsObject(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options, scoped ref ReadStack state, out object? value)
        {
        ...
        internal sealed override bool TryReadAsObject(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options, scoped ref ReadStack state, out object? value)
        {
        ...
        internal bool TryWrite(Utf8RdnWriter writer, in T? value, RdnSerializerOptions options, ref WriteStack state)
        {
            if (writer.CurrentDepth >= options.EffectiveMaxDepth)
            {
                ThrowHelper.ThrowRdnException_SerializerCycleDetected(options.EffectiveMaxDepth);
            }
            ...
            if (default(T) is null && !HandleNullOnWrite && IsNull(value))
            {
                ...
                // already handled in GetMemberAndWriteRdn() so we don't need to check for IgnoreNullValues here.
        ...
        internal bool TryWriteDataExtensionProperty(Utf8RdnWriter writer, T value, RdnSerializerOptions options, ref WriteStack state)
        {
            ...
            {
                // If not RdnDictionaryConverter<T> then we are RdnObject.
                // Avoid a type reference to RdnObject and its converter to support trimming.
                // The WriteExtensionDataValue virtual method is overridden by the RdnObject converter.
                Debug.Assert(Type == typeof(Nodes.RdnObject));
        ...
        /// <summary>
        /// Used to support RdnObject as an extension property in a loosely-typed, trimmable manner.
        /// </summary>
        /// <remarks>
        /// Writes the extension data contents without wrapping object braces.
        /// </remarks>
        internal virtual void WriteExtensionDataValue(Utf8RdnWriter writer, T value, RdnSerializerOptions options)
        {
        ...
        internal void VerifyRead(RdnTokenType tokenType, int depth, long bytesConsumed, bool isValueConverter, ref Utf8RdnReader reader)
        {
            ...
            switch (tokenType)
            {
                ...
                default:
                    ...
                    else
                    {
                        ...
                        if (!CanBePolymorphic && !(HandleNullOnRead && tokenType == RdnTokenType.Null))
                        {
                            ThrowHelper.ThrowRdnException_SerializationConverterRead(this);
                        }
                    }
        ...
        internal void VerifyWrite(int originalDepth, Utf8RdnWriter writer)
        {
            if (originalDepth != writer.CurrentDepth)
            {
                ThrowHelper.ThrowRdnException_SerializationConverterWrite(this);
            }
        }

        /// <summary>
        /// Write the value as RDN.
        /// </summary>
        /// <remarks>
        /// A converter may throw any Exception, but should throw <cref>RdnException</cref> when the RDN
        /// cannot be created.
        /// </remarks>
        /// <param name="writer">The <see cref="Utf8RdnWriter"/> to write to.</param>
...
#nullable restore
        ...
        /// <summary>
        /// Reads a dictionary key from a RDN property name.
        /// </summary>
        /// <param name="reader">The <see cref="Utf8RdnReader"/> to read from.</param>
        /// <param name="typeToConvert">The <see cref="System.Type"/> being converted.</param>
        /// <param name="options">The <see cref="RdnSerializerOptions"/> being used.</param>
        ...
        public virtual T ReadAsPropertyName(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options)
        {
            // .NET 5 backward compatibility: hardcode the default converter for primitive key serialization.
            RdnConverter<T>? fallbackConverter = GetFallbackConverterForPropertyNameSerialization(options);
        ...
        internal virtual T ReadAsPropertyNameCore(ref Utf8RdnReader reader, Type typeToConvert, RdnSerializerOptions options)
        {
        ...
        /// <summary>
        /// Writes a dictionary key as a RDN property name.
        /// </summary>
        /// <param name="writer">The <see cref="Utf8RdnWriter"/> to write to.</param>
        /// <param name="value">The value to convert. Note that the value of <seealso cref="HandleNull"/> determines if the converter handles <see langword="null" /> values.</param>
        /// <param name="options">The <see cref="RdnSerializerOptions"/> being used.</param>
        /// <remarks>Method should be overridden in custom converters of types used in serialized dictionary keys.</remarks>
        public virtual void WriteAsPropertyName(Utf8RdnWriter writer, [DisallowNull] T value, RdnSerializerOptions options)
        {
            // .NET 5 backward compatibility: hardcode the default converter for primitive key serialization.
            RdnConverter<T>? fallbackConverter = GetFallbackConverterForPropertyNameSerialization(options);
            if (fallbackConverter is null)
        ...
        internal virtual void WriteAsPropertyNameCore(Utf8RdnWriter writer, [DisallowNull] T value, RdnSerializerOptions options, bool isWritingExtensionDataProperty)
        {
            ArgumentNullException.ThrowIfNull(value);

            if (isWritingExtensionDataProperty)
            {
                // Extension data is meant as mechanism to gather unused RDN properties;
            ...
            if (originalDepth != writer.CurrentDepth || writer.TokenType != RdnTokenType.PropertyName)
            {
                ThrowHelper.ThrowRdnException_SerializationConverterWrite(this);
            }
        }
        ...
        // .NET 5 backward compatibility: hardcode the default converter for primitive key serialization.
        private RdnConverter<T>? GetFallbackConverterForPropertyNameSerialization(RdnSerializerOptions options)
        {
            ...
            if (!IsInternalConverter && options.TypeInfoResolver is not RdnSerializerContext)
            {
                ...
                if (result is null && DefaultRdnTypeInfoResolver.TryGetDefaultSimpleConverter(Type, out RdnConverter? defaultConverter))
                {
                    Debug.Assert(defaultConverter != this);
                    _fallbackConverterForPropertyNameSerialization = result = (RdnConverter<T>)defaultConverter;
                }
            }
        ...
        private RdnConverter<T>? _fallbackConverterForPropertyNameSerialization;

        internal virtual T ReadNumberWithCustomHandling(ref Utf8RdnReader reader, RdnNumberHandling handling, RdnSerializerOptions options)
            => throw new InvalidOperationException();

        internal virtual void WriteNumberWithCustomHandling(Utf8RdnWriter writer, T? value, RdnNumberHandling handling)
            => throw new InvalidOperationException();
    }
}
