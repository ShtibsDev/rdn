...
{
    /// <summary>
    /// Defines a custom exception object that is thrown when invalid RDN text is encountered, when the defined maximum depth is passed,
    /// or the RDN text is not compatible with the type of a property on an object.
    /// </summary>
    [Serializable]
    public class RdnException : Exception
    {
        ...
        /// <param name="lineNumber">The line number at which the invalid RDN was encountered (starting at 0) when deserializing.</param>
        /// <param name="bytePositionInLine">The byte count within the current line where the invalid RDN was encountered (starting at 0).</param>
        /// <param name="path">The path where the invalid RDN was encountered.</param>
        ...
        /// </remarks>
        public RdnException(string? message, string? path, long? lineNumber, long? bytePositionInLine, Exception? innerException) : base(message, innerException)
        {
            _message = message;
        ...
        /// Note that the <paramref name="bytePositionInLine"/> counts the number of bytes (i.e. UTF-8 code units) and not characters or scalars.
        /// </remarks>
        public RdnException(string? message, string? path, long? lineNumber, long? bytePositionInLine) : base(message)
        {
            _message = message;
            LineNumber = lineNumber;
            BytePositionInLine = bytePositionInLine;
        ...
        /// <param name="message">The context specific error message.</param>
        /// <param name="innerException">The exception that caused the current exception.</param>
        public RdnException(string? message, Exception? innerException) : base(message, innerException)
        {
            _message = message;
        }
        ...
        /// </summary>
        /// <param name="message">The context specific error message.</param>
        public RdnException(string? message) : base(message)
        {
            _message = message;
        }
...
#endif
        protected RdnException(SerializationInfo info, StreamingContext context) : base(info, context)
        {
        ...
        /// <summary>
        /// The path within the RDN where the exception was encountered.
        /// </summary>
