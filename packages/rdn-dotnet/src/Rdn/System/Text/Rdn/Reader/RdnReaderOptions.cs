...
{
    /// <summary>
    /// Provides the ability for the user to define custom behavior when reading RDN.
    /// </summary>
    public struct RdnReaderOptions
    {
        ...
        /// Thrown when the comment handling enum is set to a value that is not supported (i.e. not within the <see cref="RdnCommentHandling"/> enum range).
        /// </exception>
        /// <remarks>
        ...
        /// <summary>
        /// Defines whether the <see cref="Utf8RdnReader"/> should tolerate
        /// zero or more top-level RDN values that are whitespace separated.
        /// </summary>
        /// <remarks>
        /// By default, it's set to false, and <exception cref="RdnException"/> is thrown if trailing content is encountered after the first top-level RDN value.
        /// </remarks>
