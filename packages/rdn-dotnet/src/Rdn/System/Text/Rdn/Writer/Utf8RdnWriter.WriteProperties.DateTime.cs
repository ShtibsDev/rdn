...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="DateTime"/> value (as a RDN string) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// The property name should already be escaped when the instance of <see cref="RdnEncodedText"/> was created.
        /// </remarks>
        public void WriteString(RdnEncodedText propertyName, DateTime value)
        {
        ...
        /// <summary>
        /// Writes the property name and <see cref="DateTime"/> value (as a RDN string) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        private void WriteStringMinimized(ReadOnlySpan<char> escapedPropertyName, DateTime value)
        {
            ...
            RdnWriterHelper.WriteDateTimeTrimmed(output.Slice(BytesPending), value, out int bytesWritten);
        ...
        internal void WritePropertyName(DateTime value)
        {
            ...
            RdnWriterHelper.WriteDateTimeTrimmed(buffer, value, out int bytesWritten);
