...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the <see cref="int"/> value (as a RDN number) as an element of a RDN array.
        /// </summary>
        ...
        /// <summary>
        /// Writes the <see cref="long"/> value (as a RDN number) as an element of a RDN array.
        /// </summary>
        /// <param name="value">The value to write.</param>
        /// <exception cref="InvalidOperationException">
        /// Thrown if this would result in invalid RDN being written (while validation is enabled).
        ...
        {
            int maxRequired = RdnConstants.MaximumFormatInt64Length + 1; // Optionally, 1 list separator
        ...
        private void WriteNumberValueIndented(long value)
        {
            ...
            int maxRequired = indent + RdnConstants.MaximumFormatInt64Length + 1 + _newLineLength; // Optionally, 1 list separator and 1-2 bytes for new line
        ...
        {
            Span<byte> utf8Number = stackalloc byte[RdnConstants.MaximumFormatInt64Length];
