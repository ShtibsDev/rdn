...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="long"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// </remarks>
        public void WriteNumber(RdnEncodedText propertyName, long value)
        {
        ...
        /// <summary>
        /// Writes the property name and <see cref="long"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="int"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        /// <param name="propertyName">The RDN-encoded name of the property to write.</param>
        /// <param name="value">The value to write.</param>
        /// <exception cref="InvalidOperationException">
        ...
        /// </remarks>
        public void WriteNumber(RdnEncodedText propertyName, int value)
            => WriteNumber(propertyName, (long)value);

        /// <summary>
        /// Writes the property name and <see cref="int"/> value (as a RDN number) as part of a name/value pair of a RDN object.
        /// </summary>
        /// <param name="propertyName">The name of the property to write.</param>
        /// <param name="value">The value to write.</param>
        /// <exception cref="ArgumentException">
        ...
        {
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - RdnConstants.MaximumFormatInt64Length - 4);

            // All ASCII, 2 quotes for property name, and 1 colon => escapedPropertyName.Length + RdnConstants.MaximumFormatInt64Length + 3
            // Optionally, 1 list separator, and up to 3x growth when transcoding
            int maxRequired = (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatInt64Length + 4;
        ...
        {
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - RdnConstants.MaximumFormatInt64Length - 4);

            int minRequired = escapedPropertyName.Length + RdnConstants.MaximumFormatInt64Length + 3; // 2 quotes for property name, and 1 colon
        ...
        private void WriteNumberIndented(ReadOnlySpan<char> escapedPropertyName, long value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - indent - RdnConstants.MaximumFormatInt64Length - 5 - _newLineLength);

            // All ASCII, 2 quotes for property name, 1 colon, and 1 space => escapedPropertyName.Length + RdnConstants.MaximumFormatInt64Length + 4
            // Optionally, 1 list separator, 1-2 bytes for new line, and up to 3x growth when transcoding
            int maxRequired = indent + (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatInt64Length + 5 + _newLineLength;
        ...
        private void WriteNumberIndented(ReadOnlySpan<byte> escapedPropertyName, long value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - indent - RdnConstants.MaximumFormatInt64Length - 5 - _newLineLength);

            int minRequired = indent + escapedPropertyName.Length + RdnConstants.MaximumFormatInt64Length + 4; // 2 quotes for property name, 1 colon, and 1 space
        ...
        {
            Span<byte> utf8PropertyName = stackalloc byte[RdnConstants.MaximumFormatInt64Length];
