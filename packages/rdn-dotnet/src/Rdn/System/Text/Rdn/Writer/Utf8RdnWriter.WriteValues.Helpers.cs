...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Returns whether a RDN value can be written at the current position based on the current <see cref="_enclosingContainer"/>:
        /// <list type="bullet">
        /// <item>
        ...
        /// Because we designed <see cref="EnclosingContainerType.Object"/> == <see cref="RdnTokenType.PropertyName"/>, we can just check for equality.
        /// </item>
        /// <item>
        ...
        /// Writing a value is never valid and <see cref="_enclosingContainer"/> does not equal any <see cref="RdnTokenType"/> by construction.
        /// </item>
        /// </list>
        ...
        /// </summary>
        private bool CanWriteValue => _enclosingContainer == EnclosingContainerType.Array | _enclosingContainer == EnclosingContainerType.Set | _enclosingContainer == EnclosingContainerType.Map | _enclosingContainer == EnclosingContainerType.Tuple | (byte)_enclosingContainer == (byte)_tokenType;
