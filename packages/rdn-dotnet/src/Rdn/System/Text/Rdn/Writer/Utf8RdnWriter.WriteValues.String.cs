...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded text value (as a RDN string) as an element of a RDN array.
        /// </summary>
        ...
        /// </exception>
        public void WriteStringValue(RdnEncodedText value)
        {
        ...
        /// <summary>
        /// Writes the string text value (as a RDN string) as an element of a RDN array.
        /// </summary>
        ...
        /// <summary>
        /// Writes the text value (as a RDN string) as an element of a RDN array.
        /// </summary>
        /// <param name="value">The value to write.</param>
        /// <exception cref="ArgumentException">
        /// Thrown when the specified value is too large.
        ...
        {
            Debug.Assert(escapedValue.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - 3);

            // All ASCII, 2 quotes => escapedValue.Length + 2
            // Optionally, 1 list separator, and up to 3x growth when transcoding
            int maxRequired = (escapedValue.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + 3;
        ...
        private void WriteStringIndented(ReadOnlySpan<char> escapedValue)
        {
            ...
            Debug.Assert(escapedValue.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - indent - 3 - _newLineLength);

            // All ASCII, 2 quotes => indent + escapedValue.Length + 2
            // Optionally, 1 list separator, 1-2 bytes for new line, and up to 3x growth when transcoding
            int maxRequired = indent + (escapedValue.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + 3 + _newLineLength;
        ...
        /// <summary>
        /// Writes the UTF-8 text value (as a RDN string) as an element of a RDN array.
        /// </summary>
        /// <param name="utf8Value">The UTF-8 encoded value to be written as a RDN string element of a RDN array.</param>
        /// <exception cref="ArgumentException">
        /// Thrown when the specified value is too large.
        /// </exception>
        /// <exception cref="InvalidOperationException">
        ...
        /// <summary>
        /// Writes a number as a RDN string. The string value is not escaped.
        /// </summary>
