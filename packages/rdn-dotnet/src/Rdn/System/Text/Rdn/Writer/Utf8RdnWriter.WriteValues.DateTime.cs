...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the <see cref="DateTime"/> value (as a RDN string) as an element of a RDN array.
        /// </summary>
        ...
        {
            int maxRequired = RdnConstants.MaximumFormatDateTimeOffsetLength + 3; // 2 quotes, and optionally, 1 list separator
        ...
        private void WriteStringValueIndented(DateTime value)
        {
            ...
            int maxRequired = indent + RdnConstants.MaximumFormatDateTimeOffsetLength + 3 + _newLineLength;
