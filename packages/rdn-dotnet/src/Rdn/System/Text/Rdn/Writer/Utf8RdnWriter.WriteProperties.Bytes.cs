...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and raw bytes value (as a Base64 encoded RDN string) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// </exception>
        public void WriteBase64String(RdnEncodedText propertyName, ReadOnlySpan<byte> bytes)
        {
        ...
        /// <summary>
        /// Writes the property name and raw bytes value (as a Base64 encoded RDN string) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        private void WriteBase64Minimized(ReadOnlySpan<char> escapedPropertyName, ReadOnlySpan<byte> bytes)
        {
            ...
            Debug.Assert(escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding < int.MaxValue - encodedLength - 6);
            ...
            int maxRequired = (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + encodedLength + 6;
        ...
        private void WriteBase64Indented(ReadOnlySpan<char> escapedPropertyName, ReadOnlySpan<byte> bytes)
        {
            ...
            Debug.Assert(escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding < int.MaxValue - indent - encodedLength - 7 - _newLineLength);
            ...
            int maxRequired = indent + (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + encodedLength + 7 + _newLineLength;
