...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the text value segment as a partial RDN string.
        /// </summary>
        ...
        /// Thrown when validation is enabled if this would result in invalid RDN being written or
        ...
        private void WriteStringSegmentEscape(ReadOnlySpan<char> value, bool isFinalSegment)
        {
            ...
            int escapeIdx = RdnWriterHelper.NeedsEscaping(value, _options.Encoder);
            if (escapeIdx != -1)
            {
        ...
        private void WriteStringSegmentEscapeValue(ReadOnlySpan<char> value, int firstEscapeIndexVal, bool isFinalSegment)
        {
            ...
            RdnWriterHelper.EscapeString(value, escapedValue, firstEscapeIndexVal, _options.Encoder, out int consumed, out int written, isFinalSegment);
        ...
        {
            Debug.Assert(escapedValue.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding));

            int requiredBytes = escapedValue.Length * RdnConstants.MaxExpansionFactorWhileTranscoding;
        ...
        /// <summary>
        /// Writes the UTF-8 text value segment as a partial RDN string.
        /// </summary>
        /// <param name="value">The UTF-8 encoded value to be written as a RDN string element of a RDN array.</param>
        /// <param name="isFinalSegment">Indicates that this is the final segment of the string.</param>
        /// <exception cref="ArgumentException">
        /// Thrown when the specified value is too large.
        /// </exception>
        ...
        private void WriteStringSegmentEscape(ReadOnlySpan<byte> utf8Value, bool isFinalSegment)
        {
            ...
            int escapeIdx = RdnWriterHelper.NeedsEscaping(utf8Value, _options.Encoder);
            if (escapeIdx != -1)
            {
        ...
        private void WriteStringSegmentEscapeValue(ReadOnlySpan<byte> utf8Value, int firstEscapeIndexVal, bool isFinalSegment)
        {
            ...
            RdnWriterHelper.EscapeString(utf8Value, escapedValue, firstEscapeIndexVal, _options.Encoder, out int consumed, out int written, isFinalSegment);
        ...
        /// <summary>
        /// Writes the input bytes as a partial RDN string.
        /// </summary>
        /// <param name="value">The bytes to be written as a RDN string element of a RDN array.</param>
        /// <param name="isFinalSegment">Indicates that this is the final segment of the string.</param>
        /// <exception cref="ArgumentException">
        /// Thrown when the specified value is too large.
        /// </exception>
        ...
        private void WriteStringSegmentEpilogue()
        {
            ...
            _memory.Span[BytesPending++] = RdnConstants.Quote;
        }
