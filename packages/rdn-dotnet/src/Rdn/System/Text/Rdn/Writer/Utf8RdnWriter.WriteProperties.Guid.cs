...
namespace Rdn
{
    ...
    {
        /// <summary>
        /// Writes the pre-encoded property name and <see cref="Guid"/> value (as a RDN string) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        /// </remarks>
        public void WriteString(RdnEncodedText propertyName, Guid value)
        {
        ...
        /// <summary>
        /// Writes the property name and <see cref="Guid"/> value (as a RDN string) as part of a name/value pair of a RDN object.
        /// </summary>
        ...
        {
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - RdnConstants.MaximumFormatGuidLength - 6);

            // All ASCII, 2 quotes for property name, 2 quotes for date, and 1 colon => escapedPropertyName.Length + RdnConstants.MaximumFormatGuidLength + 5
            // Optionally, 1 list separator, and up to 3x growth when transcoding
            int maxRequired = (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatGuidLength + 6;
        ...
        {
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - RdnConstants.MaximumFormatGuidLength - 6);

            int minRequired = escapedPropertyName.Length + RdnConstants.MaximumFormatGuidLength + 5; // 2 quotes for property name, 2 quotes for date, and 1 colon
        ...
        private void WriteStringIndented(ReadOnlySpan<char> escapedPropertyName, Guid value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < (int.MaxValue / RdnConstants.MaxExpansionFactorWhileTranscoding) - indent - RdnConstants.MaximumFormatGuidLength - 7 - _newLineLength);

            // All ASCII, 2 quotes for property name, 2 quotes for date, 1 colon, and 1 space => escapedPropertyName.Length + RdnConstants.MaximumFormatGuidLength + 6
            // Optionally, 1 list separator, 1-2 bytes for new line, and up to 3x growth when transcoding
            int maxRequired = indent + (escapedPropertyName.Length * RdnConstants.MaxExpansionFactorWhileTranscoding) + RdnConstants.MaximumFormatGuidLength + 7 + _newLineLength;
        ...
        private void WriteStringIndented(ReadOnlySpan<byte> escapedPropertyName, Guid value)
        {
            ...
            Debug.Assert(escapedPropertyName.Length < int.MaxValue - indent - RdnConstants.MaximumFormatGuidLength - 7 - _newLineLength);

            int minRequired = indent + escapedPropertyName.Length + RdnConstants.MaximumFormatGuidLength + 6; // 2 quotes for property name, 2 quotes for date, 1 colon, and 1 space
        ...
        {
            Span<byte> utf8PropertyName = stackalloc byte[RdnConstants.MaximumFormatGuidLength];
