...
using Rdn.Text.Unicode;

namespace Rdn.Encodings.Web
{
    /// <summary>
    ...
    public abstract class JavaScriptEncoder : TextEncoder
    {
        ...
        /// </para>
        /// </remarks>
        public static JavaScriptEncoder UnsafeRelaxedRdnEscaping => DefaultJavaScriptEncoder.UnsafeRelaxedEscapingSingleton;
